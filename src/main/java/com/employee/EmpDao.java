...
public class EmpDao {
	...
	public static Connection getConnection() {
		...
		try {
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/servlet_curd","root","Root@Mysql123");  
	...
	public static int update(EmpPOJO e){  
        int status=0;  
        try{  
            Connection con=EmpDao.getConnection();  
	 ...
	 public static EmpPOJO getEmployeeById(int id){  
